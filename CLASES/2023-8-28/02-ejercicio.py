# Escribir una clase Persona con los siguientes atributos y metodos:
# - Atributos: nombre, apellido, edad, altura y peso.
# - Metodos: constructor, nombreCompleto(), con formato "apellido, nombre", esMayor(), 
# imc() y __str__() que muestre todos los atributos de la persona.
